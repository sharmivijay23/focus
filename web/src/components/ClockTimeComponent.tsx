  ...
  return (
    <div className="flex flex-col ml-6">
      ...
      <div className="text-gray-400"> Clock helps you track time across different time zones and easily switch between 12-hour and 24-hour formats for
        user-friendly timekeeping.</div>  {/* think about deleting 'different time zones'  */}
      <div className="flex flex-row">
        <div className="flex flex-col justify-center m-6">
          <div className={timeFormat === 'standardTimeFormat' ? selected_clock_class : clock_class} onClick={() => handleTimeFormat("standardTimeFormat")}>
            1:45
          </div>
          <div className="flex justify-center items-center mt-2">12-hour clock</div>
        </div>
        <div className="flex flex-col justify-center m-6">
          <div className={timeFormat === 'militaryTimeFormat' ? selected_clock_class : clock_class} onClick={() => handleTimeFormat("militaryTimeFormat")}>
            13:45
          </div>
